...
public class GuiPersistentMapOptions extends GuiScreenMinimap {
    ...
    public void initGui() {
        ...
        for (int t = 0; t < relevantOptions.length; t++) {
            ...
            GuiOptionButtonMinimap var7 = new GuiOptionButtonMinimap(
                ...
                public void onClick(double p_onClick_1_, double p_onClick_3_) {
                    GuiPersistentMapOptions.this.actionPerformed(this);
                }
            };
            this.addButton(var7);
            var2++;
            ...
            if (option.isFloat()) {
                ...
                this.addButton(
                        new GuiOptionSliderMinimap(
                                option.returnEnumOrdinal(), this.getWidth() / 2 - 155 + var2 % 2 * 160, this.getHeight() / 6 + 24 * (var2 >> 1), option, fValue, this.options
                        )
                );
            } else {
                GuiOptionButtonMinimap var7 = new GuiOptionButtonMinimap(
        ...
        this.addButton(new GuiButton(200, this.getWidth() / 2 - 100, this.getHeight() / 6 + 168, I18nUtils.getString("gui.done")) {
            public void onClick(double p_onClick_1_, double p_onClick_3_) {
                GuiPersistentMapOptions.this.getMinecraft().displayGuiScreen(GuiPersistentMapOptions.this.parent);
            }
        });
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        if (par1GuiButton.enabled && par1GuiButton.id < 100 && par1GuiButton instanceof GuiOptionButtonMinimap) {
