...
public class WaypointManager implements IWaypointManager {
    ...
    public String getMapName() {
        return this.game.getServer().getLevelName();
    }
    ...
    public void handleDeath() {
        ...
        if (this.options.deathpoints != 0) {
            ...
            this.addWaypoint(
                    new Waypoint(
                            "Latest Death",
                            thePlayer.dimension != DimensionType.THE_NETHER ? GameVariableAccessShim.xCoord() : GameVariableAccessShim.xCoord() * 8,
                            thePlayer.dimension != DimensionType.THE_NETHER ? GameVariableAccessShim.zCoord() : GameVariableAccessShim.zCoord() * 8,
                ...
                if (!pt.name.startsWith("^")) {
                    ...
                    if (dimensionsString.equals("")) {
                        dimensionsString = dimensionsString
                                ...
                                .getDimensionManager()
                                .getDimensionContainerByIdentifier(DimensionType.getId(DimensionType.OVERWORLD).toString())
                                .getStorageName();
                        dimensionsString = dimensionsString
                                + AbstractVoxelMap.getInstance()
                                .getDimensionManager()
                                .getDimensionContainerByIdentifier(DimensionType.getId(DimensionType.THE_NETHER).toString())
                                .getStorageName();
                    }
