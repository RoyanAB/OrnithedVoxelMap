...
import com.mamiyaotaru.voxelmap.ornithe.mixins.EntityRendererAccessor;
...
public class Radar implements IRadar {
    ...
    public void onResourceManagerReload(ResourceManager resourceManager) {
        ...
        this.fontRenderer.onResourceReload(resourceManager);
    }
        ...
        try {
            ...
            for (int t = 0; t < this.mobImages.length; t++) {
                try {
                    ...
                    InputStream is = null;
                    if (is == null) {
                        fullPath = "textures/icons/entity.minecraft." + EnumMobs.values()[t].id.toLowerCase() + ".png";
                    ...
                    if (is == null) {
                        fullPath = "textures/icons/entity.minecraft." + EnumMobs.values()[t].id.toLowerCase() + "8.png";
                    ...
                    if (is == null) {
                        intendedSize = 16;
                        fullPath = "textures/icons/entity.minecraft." + EnumMobs.values()[t].id.toLowerCase() + "16.png";
                    ...
                    if (is == null) {
                        intendedSize = 32;
                        fullPath = "textures/icons/entity.minecraft." + EnumMobs.values()[t].id.toLowerCase() + "32.png";
            ...
            this.armorImages[0][0] = ImageUtils.loadImage(new Identifier("textures/models/armor/leather_layer_1.png"), 8, 8, 8, 8);
            this.armorImages[1][0] = ImageUtils.loadImage(new Identifier("textures/models/armor/leather_layer_1.png"), 40, 8, 8, 8);
            this.armorImages[2][0] = ImageUtils.loadImage(new Identifier("textures/models/armor/leather_layer_1_overlay.png"), 8, 8, 8, 8);
            this.armorImages[3][0] = ImageUtils.loadImage(new Identifier("textures/models/armor/leather_layer_1_overlay.png"), 40, 8, 8, 8);
            this.armorImages[4][0] = ImageUtils.addImages(
                    ImageUtils.loadImage(new Identifier("textures/models/armor/chainmail_layer_1.png"), 8, 8, 8, 8),
                    ImageUtils.loadImage(new Identifier("textures/models/armor/chainmail_layer_1.png"), 40, 8, 8, 8),
                    0.0F,
                    0.0F,
                    8,
                    8
            ...
            this.armorImages[5][0] = ImageUtils.addImages(
                    ImageUtils.loadImage(new Identifier("textures/models/armor/iron_layer_1.png"), 8, 8, 8, 8),
                    ImageUtils.loadImage(new Identifier("textures/models/armor/iron_layer_1.png"), 40, 8, 8, 8),
                    0.0F,
                    0.0F,
                    8,
                    8
            ...
            this.armorImages[6][0] = ImageUtils.addImages(
                    ImageUtils.loadImage(new Identifier("textures/models/armor/gold_layer_1.png"), 8, 8, 8, 8),
                    ImageUtils.loadImage(new Identifier("textures/models/armor/gold_layer_1.png"), 40, 8, 8, 8),
                    0.0F,
                    0.0F,
                    8,
                    8
            ...
            this.armorImages[7][0] = ImageUtils.addImages(
                    ImageUtils.loadImage(new Identifier("textures/models/armor/diamond_layer_1.png"), 8, 8, 8, 8),
                    ImageUtils.loadImage(new Identifier("textures/models/armor/diamond_layer_1.png"), 40, 8, 8, 8),
                    0.0F,
                    0.0F,
                    8,
                    8
            ...
            this.armorImages[8][0] = ImageUtils.addImages(
                    ImageUtils.loadImage(new Identifier("textures/models/armor/turtle_layer_1.png"), 8, 8, 8, 8),
                    ImageUtils.loadImage(new Identifier("textures/models/armor/turtle_layer_1.png"), 40, 8, 8, 8),
                    0.0F,
                    0.0F,
                    8,
                    8
            ...
            try {
                if (this.isEntityShown(entity)) {
                    ...
                    if (hypot < 961.0) {
                        ...
                        String scrubbedName = TextUtils.scrubCodes(contact.entity.getName().asString());
    ...
    private void tryAutoIcon(Contact contact) {
        EntityRenderer<? extends Entity> render = this.game.getEntityRenderManager().getRenderer(contact.entity);
//      Identifier resourceLocation = VoxelMapProtectedFieldsHelper.getRendersResourceLocation(render, contact.entity);
        Identifier resourceLocation = ((EntityRendererAccessor) render).invokerGetTexture(contact.entity);
    ...
    private BufferedImage createAutoIconImageFromResourceLocation(Contact contact, EntityRenderer<? extends Entity> render, Identifier resourceLocation) {
        BufferedImage headImage = null;
        if (GLUtils.fboEnabled && render instanceof LivingEntityRenderer) {
            try {
                EntityModel<? extends LivingEntity> model = ((LivingEntityRenderer) render).getModel();
                if (render instanceof TropicalFishEntityRenderer) {
                    Object fishModel = null;
                    int size = ((TropicalFishEntity) contact.entity).getShape();
                    if (size == 0) {
                        fishModel = ReflectionUtils.getPrivateFieldValueByType(render, TropicalFishEntityRenderer.class, TropicalFishEntityModelA.class);
                    } else {
                        fishModel = ReflectionUtils.getPrivateFieldValueByType(render, TropicalFishEntityRenderer.class, TropicalFishEntityModelB.class);
                    }

                    if (fishModel != null) {
                        model = (EntityModel<? extends LivingEntity>) fishModel;
                    }
                }
                ...
                if (is != null) {
                    ...
                    for (ModelPart bit : headPartsArrayList) {
                        if (bit.children != null) {
                            purge.addAll(bit.children);
                        }
                    }
                ...
                if (headBits == null) {
                    if (model instanceof BatEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, BatEntityModel.class, ModelPart.class)};
                    } else if (model instanceof BipedEntityModel) {
                        headBits = new ModelPart[]{((BipedEntityModel) model).head, ((BipedEntityModel) model).helmet};
                    } else if (model instanceof BlazeEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, BlazeEntityModel.class, ModelPart.class)};
                    ...
                    } else if (model instanceof CowEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, CowEntityModel.class, ModelPart.class)};
                    } else if (model instanceof CreeperEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, CreeperEntityModel.class, ModelPart.class)};
                    } else if (model instanceof DolphinEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, DolphinEntityModel.class, ModelPart.class)};
                    } else if (model instanceof DragonEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, DragonEntityModel.class, ModelPart.class)};
                    } else if (model instanceof GhastEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, GhastEntityModel.class, ModelPart.class)};
                    } else if (model instanceof GuardianEntityModel) {
                        headBits = new ModelPart[]{
                                (ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, GuardianEntityModel.class, ModelPart.class, 0),
                                (ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, GuardianEntityModel.class, ModelPart.class, 1)
                        };
                    } else if (model instanceof HorseEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, HorseEntityModel.class, ModelPart.class)};
                    } else if (model instanceof IllagerEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, IllagerEntityModel.class, ModelPart.class)};
                    } else if (model instanceof IronGolemEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, IronGolemEntityModel.class, ModelPart.class)};
                        ...
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, PhantomEntityModel.class, ModelPart.class)};
                    } else if (model instanceof PigEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, PigEntityModel.class, ModelPart.class)};
                    } else if (model instanceof PolarBearEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, PolarBearEntityModel.class, ModelPart.class)};
                        ...
                        headBits = new ModelPart[]{
                                ...
                                (ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, RabbitEntityModel.class, ModelPart.class, 10)
                        };
                    } else if (model instanceof RavagerEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, RavagerEntityModel.class, ModelPart.class, 7)};
                    } else if (model instanceof ShulkerEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, ShulkerEntityModel.class, ModelPart.class, 2)};
                    } else if (model instanceof SilverfishEntityModel) {
                        headBits = new ModelPart[]{
                                (ModelPart) ((Object[]) ReflectionUtils.getPrivateFieldValueByType(model, SilverfishEntityModel.class, ModelPart[].class))[0],
                                (ModelPart) ((Object[]) ReflectionUtils.getPrivateFieldValueByType(model, SilverfishEntityModel.class, ModelPart[].class))[1]
                        };
                    } else if (model instanceof SlimeEntityModel) {
                        Model modelOuter = new SlimeEntityModel(0);
                        headBits = new ModelPart[]{
                                (ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, SlimeEntityModel.class, ModelPart.class, 0),
                                (ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, SlimeEntityModel.class, ModelPart.class, 1),
                                (ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, SlimeEntityModel.class, ModelPart.class, 2),
                                (ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, SlimeEntityModel.class, ModelPart.class, 3),
                                (ModelPart) ReflectionUtils.getPrivateFieldValueByType(modelOuter, SlimeEntityModel.class, ModelPart.class, 0)
                        };
                    } else if (model instanceof SnowmanEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, SnowmanEntityModel.class, ModelPart.class, 2)};
                    } else if (model instanceof SpiderEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, SpiderEntityModel.class, ModelPart.class)};
                    } else if (model instanceof SquidEntityModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, SquidEntityModel.class, ModelPart.class)};
                    } else if (model instanceof VillagerResemblingModel) {
                        headBits = new ModelPart[]{(ModelPart) ReflectionUtils.getPrivateFieldValueByType(model, VillagerResemblingModel.class, ModelPart.class)};
                        ...
                        for (Field submodelArrayx : submodelArrays) {
                            ...
                            if (name.contains("head")
                                ...
                                ModelPart[] submodelArrayValue = (ModelPart[]) submodelArrayx.get(model);
                        ...
                        for (Field submodelx : submodels) {
                            ...
                            if (name.contains("head")
                                ...
                                headPartsArrayList.add((ModelPart) submodelx.get(model));
                            }
                        }
                        ...
                        for (ModelPart bitx : headPartsArrayList) {
                            if (bitx.children != null) {
                                purge.addAll(bitx.children);
                            }
                        }
    ...
    private boolean drawModel(
            float scale, int captureDepth, LivingEntity par5EntityLivingBase, Direction facing, EntityModel model, Identifier resourceLocation, ModelPart... headBits
    ) {
        ...
        try {
            ...
            for (int t = 0; t < headBits.length; t++) {
                if (headBits[t].pivotY < minY) {
                    minY = headBits[t].pivotY;
                }

                if (headBits[t].pivotY > maxY) {
                    maxY = headBits[t].pivotY;
                }
            }
            ...
            for (int t = 0; t < headBits.length; t++) {
                float y = headBits[t].pivotY;
                headBits[t].pivotY += offsetByY;
    ...
    private Sprite[] getIconsForRandomob(Contact contact) {
        ...
        EntityRenderer<? extends Entity> render = this.game.getEntityRenderManager().getRenderer(contact.entity);
        resourceLocation = ((EntityRendererAccessor) render).invokerGetTexture(contact.entity);
        ...
        if (icon == this.textureAtlas.getMissingImage()) {
            BufferedImage mobImage = null;
            if (contact.type == EnumMobs.HORSE) {
                Texture textureObject = GLUtils.textureManager.getTexture(resourceLocation);
                if (textureObject != null) {
                    mobImage = ImageUtils.createBufferedImageFromGLID(textureObject.getGlId());
        ...
        if (icon0 == this.textureAtlas.getMissingImage()) {
            ...
            if (checkCount < 5) {
                ...
                try {
                    ...
                    imageData = AbstractClientPlayerEntity.loadSkin(player.getSkinTexture(), player.getName().getString());
                    if (imageData == null) {
                        throw new Exception("failed to get skin: image data was null");
                    }

                    BufferedImage skinImage = ImageUtils.createBufferedImageFromGLID(imageData.getGlId());
                    boolean showHat = player.isPartVisible(PlayerModelPart.HAT);
                    if (showHat) {
        ...
        if (contact.type == EnumMobs.SHEEP) {
            ...
            if (helmet == Items.SKELETON_SKULL) {
                ...
                if (stack.hasTag()) {
                    ...
                    if (nbttagcompound.contains("SkullOwner", 10)) {
                        ...
                        if (name != null && !name.equals("")) {
                            gameProfile = SkullBlockEntity.loadProperties(new GameProfile(null, name));
                            nbttagcompound.put("SkullOwner", NbtHelper.fromGameProfile(new CompoundTag(), gameProfile));
                        }
                    }
                }
                ...
                if (gameProfile != null) {
                    ...
                    java.util.Map<Type, MinecraftProfileTexture> map = minecraft.getSkinProvider().getTextures(gameProfile);
                    if (map.containsKey(Type.SKIN)) {
                        resourcelocation = minecraft.getSkinProvider().loadSkin(map.get(Type.SKIN), Type.SKIN);
                    }
                    ...
                    if (resourcelocation != null) {
                        ...
                        if (icon0 == this.textureAtlas.getMissingImage()) {
                            Texture textureObject = GLUtils.textureManager.getTexture(resourcelocation);
                            if (textureObject != null) {
                                BufferedImage image = ImageUtils.createBufferedImageFromGLID(textureObject.getGlId());
                                if (image != null) {
                ...
                if (helmetArmor instanceof DyeableArmorItem) {
                    contact.setArmorColor(((DyeableArmorItem) helmetArmor).getColor(stack));
                }
            } else if (helmet instanceof BlockItem) {
                Block block = ((BlockItem) helmet).getBlock();
    ...
    private Sprite[] createUnknownArmorIcons(Contact contact, ItemStack stack, Item helmet) {
        ...
        try {
            String texture = ((ArmorItem) helmet).getMaterial().getName();
        ...
        Method getModel = m;
        BipedEntityModel<? extends LivingEntity> modelBiped = null;

        try {
            if (getModel != null) {
                modelBiped = (BipedEntityModel<? extends LivingEntity>) getModel.invoke(null, contact.entity, stack, EquipmentSlot.HEAD, null);
            }
        } catch (Exception var16) {
        }

        if (modelBiped != null && resourceLocation != null && GLUtils.fboEnabled) {
            ModelPart[] headBits = new ModelPart[]{modelBiped.head, modelBiped.helmet};
            this.drawModel(0.888888F, 2, (LivingEntity) contact.entity, Direction.NORTH, modelBiped, resourceLocation, headBits);
    ...
    private EnumMobs getContactTypeStrict(Entity entity) {
        ...
        if (entityClass.equals(BatEntity.class)) {
            return EnumMobs.BAT;
        } else if (entityClass.equals(BlazeEntity.class)) {
            return EnumMobs.BLAZE;
        } else if (entityClass.equals(CatEntity.class)) {
            return EnumMobs.CAT;
        } else if (entityClass.equals(CaveSpiderEntity.class)) {
            return EnumMobs.CAVESPIDER;
        } else if (entityClass.equals(ChickenEntity.class)) {
            return EnumMobs.CHICKEN;
        } else if (entityClass.equals(MooshroomEntity.class)) {
            return EnumMobs.MOOSHROOM;
        } else if (entityClass.equals(CodEntity.class)) {
            return EnumMobs.COD;
        } else if (entityClass.equals(CowEntity.class)) {
            return EnumMobs.COW;
        } else if (entityClass.equals(CreeperEntity.class)) {
        ...
        } else if (entityClass.equals(EnderDragonEntity.class)) {
            return EnumMobs.ENDERDRAGON;
        } else if (entityClass.equals(EndermanEntity.class)) {
            return EnumMobs.ENDERMAN;
        } else if (entityClass.equals(EndermiteEntity.class)) {
            return EnumMobs.ENDERMITE;
        } else if (entityClass.equals(EvokerEntity.class)) {
            return EnumMobs.EVOKER;
        } else if (entityClass.equals(GhastEntity.class)) {
            return EnumMobs.GHAST;
        } else if (entityClass.equals(GuardianEntity.class)) {
            return EnumMobs.GUARDIAN;
        } else if (entityClass.equals(ElderGuardianEntity.class)) {
            return EnumMobs.GUARDIANELDER;
        } else if (entityClass.equals(HorseEntity.class)
                || entityClass.equals(DonkeyEntity.class)
                || entityClass.equals(MuleEntity.class)
                || entityClass.equals(SkeletonHorseEntity.class)
                || entityClass.equals(ZombieHorseEntity.class)) {
            return EnumMobs.HORSE;
        } else if (entityClass.equals(HuskEntity.class)) {
            return EnumMobs.HUSK;
        } else if (entityClass.equals(LlamaEntity.class)) {
            return EnumMobs.LLAMA;
        } else if (entityClass.equals(TraderLlamaEntity.class)) {
            return EnumMobs.LLAMATRADER;
        } else if (entityClass.equals(IronGolemEntity.class)) {
            return EnumMobs.IRONGOLEM;
        } else if (entityClass.equals(MagmaCubeEntity.class)) {
            return EnumMobs.MAGMA;
        } else if (entityClass.equals(OcelotEntity.class)) {
            return EnumMobs.OCELOT;
        } else if (entityClass.equals(ParrotEntity.class)) {
            return EnumMobs.PARROT;
        } else if (entityClass.equals(PhantomEntity.class)) {
            return EnumMobs.PHANTOM;
        } else if (entityClass.equals(PigEntity.class)) {
            return EnumMobs.PIG;
        } else if (entityClass.equals(ZombiePigmanEntity.class)) {
            return EnumMobs.PIGZOMBIE;
        } else if (entity instanceof OtherClientPlayerEntity) {
            return EnumMobs.PLAYER;
        } else if (entityClass.equals(PolarBearEntity.class)) {
            return EnumMobs.POLARBEAR;
        } else if (entityClass.equals(PufferfishEntity.class)) {
            return EnumMobs.PUFFERFISH;
        } else if (entityClass.equals(RabbitEntity.class)) {
            return EnumMobs.RABBIT;
        } else if (entityClass.equals(SalmonEntity.class)) {
            return EnumMobs.SALMON;
        } else if (entityClass.equals(SheepEntity.class)) {
            return EnumMobs.SHEEP;
        } else if (entityClass.equals(ShulkerEntity.class)) {
            return EnumMobs.SHULKER;
        } else if (entityClass.equals(SilverfishEntity.class)) {
            return EnumMobs.SILVERFISH;
        } else if (entityClass.equals(SkeletonEntity.class)) {
            return EnumMobs.SKELETON;
        } else if (entityClass.equals(WitherSkeletonEntity.class)) {
            return EnumMobs.SKELETONWITHER;
        } else if (entityClass.equals(SlimeEntity.class)) {
            return EnumMobs.SLIME;
        } else if (entityClass.equals(SnowGolemEntity.class)) {
            return EnumMobs.SNOWGOLEM;
        } else if (entityClass.equals(SpiderEntity.class)) {
            return EnumMobs.SPIDER;
        } else if (entityClass.equals(SquidEntity.class)) {
            return EnumMobs.SQUID;
        } else if (entityClass.equals(TropicalFishEntity.class)) {
            return ((TropicalFishEntity) entity).getShape() == 0 ? EnumMobs.TROPICALFISHA : EnumMobs.TROPICALFISHB;
        } else if (entityClass.equals(StrayEntity.class)) {
            return EnumMobs.STRAY;
        } else if (entityClass.equals(TurtleEntity.class)) {
            return EnumMobs.TURTLE;
        } else if (entityClass.equals(VexEntity.class)) {
            return EnumMobs.VEX;
        } else if (entityClass.equals(VillagerEntity.class)) {
            return EnumMobs.VILLAGER;
        } else if (entityClass.equals(VindicatorEntity.class)) {
            return EnumMobs.VINDICATOR;
        } else if (entityClass.equals(WitchEntity.class)) {
            return EnumMobs.WITCH;
        } else if (entityClass.equals(WitherEntity.class)) {
            return EnumMobs.WITHER;
        } else if (entityClass.equals(WolfEntity.class)) {
            boolean tamed = ((WolfEntity) entity).isTamed();
            boolean angry = ((WolfEntity) entity).isAngry();
            return tamed ? EnumMobs.WOLFTAME : (angry ? EnumMobs.WOLFANGRY : EnumMobs.WOLF);
        } else if (entityClass.equals(ZombieEntity.class)) {
            return EnumMobs.ZOMBIE;
        } else {
            return entityClass.equals(ZombieVillagerEntity.class) ? EnumMobs.ZOMBIEVILLAGER : EnumMobs.UNKNOWN;
        }
    }
    ...
    private EnumMobs getContactType(Entity entity) {
        if (entity instanceof BatEntity) {
            ...
            return entity instanceof ZombieEntity ? EnumMobs.ZOMBIE : EnumMobs.UNKNOWN;
        }
    }
                ...
                try {
                    ...
                    if (contact.type == EnumMobs.GHAST
                        ...
                        if (contact.type == EnumMobs.GHAST || contact.type == EnumMobs.GHASTATTACKING) {
                            EntityRenderer<Entity> render = this.game.getEntityRenderManager().getRenderer(contact.entity);
                            String path = ((EntityRendererAccessor) render).invokerGetTexture(contact.entity).getPath();
                        ...
                        if (contact.armorColor != -1) {
                            ...
                            if (contact.type == EnumMobs.SHEEP) {
                                ...
                                if (sheepEntity.hasCustomName() && "jeb_".equals(sheepEntity.getName().asString())) {
                                    int semiRandom = sheepEntity.age / 25 + sheepEntity.getEntityId();
                                    int numDyeColors = DyeColor.values().length;
                                    int colorID1 = semiRandom % numDyeColors;
                                    int colorID2 = (semiRandom + 1) % numDyeColors;
                                    float lerpVal = (sheepEntity.age % 25 + this.game.getTickDelta()) / 25.0F;
