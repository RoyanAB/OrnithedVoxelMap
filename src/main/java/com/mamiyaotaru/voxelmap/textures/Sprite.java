...
public class Sprite {
	...
	public void copyFrom(TextureAtlasSprite sourceSprite) {
		this.originX = sourceSprite.getOriginX();
		this.originY = sourceSprite.getOriginY();
		this.width = sourceSprite.getIconWidth();
		this.height = sourceSprite.getIconHeight();
		this.minU = sourceSprite.getMinU();
		this.maxU = sourceSprite.getMaxU();
		this.minV = sourceSprite.getMinV();
		this.maxV = sourceSprite.getMaxV();
	}
