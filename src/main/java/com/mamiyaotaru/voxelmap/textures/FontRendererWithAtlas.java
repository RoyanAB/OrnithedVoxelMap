...
public class FontRendererWithAtlas extends FontRenderer implements IResourceManagerReloadListener {
    ...
    public FontRendererWithAtlas(TextureManager renderEngine, ResourceLocation locationFontTexture) {
        super(renderEngine, new Font(renderEngine, locationFontTexture));
            ...
            if (character == 167 && textIndex + 1 < text.length()) {
                ...
                if (charIndex != -1) {
                    if (this.randomStyle) {
                        int randomCharIndex;
                        do {
                            randomCharIndex = this.field_78289_c.nextInt(this.charWidthArray.length);
                    ...
                    if (this.strikethroughStyle) {
                        ...
                        vertexBuffer.pos(this.posX, this.posY + this.field_78288_b / 2, 0.0).endVertex();
                        vertexBuffer.pos(this.posX + widthOfRenderedChar, this.posY + this.field_78288_b / 2, 0.0).endVertex();
                        vertexBuffer.pos(this.posX + widthOfRenderedChar, this.posY + this.field_78288_b / 2 - 1.0F, 0.0).endVertex();
                        vertexBuffer.pos(this.posX, this.posY + this.field_78288_b / 2 - 1.0F, 0.0).endVertex();
                        tessellator.draw();
                    ...
                    if (this.underlineStyle) {
                        ...
                        vertexBuffer.pos(this.posX + l, this.posY + this.field_78288_b, 0.0).endVertex();
                        vertexBuffer.pos(this.posX + widthOfRenderedChar, this.posY + this.field_78288_b, 0.0).endVertex();
                        vertexBuffer.pos(this.posX + widthOfRenderedChar, this.posY + this.field_78288_b - 1.0F, 0.0).endVertex();
                        vertexBuffer.pos(this.posX + l, this.posY + this.field_78288_b - 1.0F, 0.0).endVertex();
                        tessellator.draw();
                        GLShim.glEnable(3553);
                    }
