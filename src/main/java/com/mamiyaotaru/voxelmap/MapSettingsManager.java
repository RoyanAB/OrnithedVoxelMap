...
public class MapSettingsManager implements ISettingsManager {
    ...
    public int sort = 1;
    public KeyBinding keyBindZoom = new KeyBinding("key.minimap.zoom", InputMappings.getInputByName("key.keyboard.z").getKeyCode(), "controls.minimap.title");
    public KeyBinding keyBindFullscreen = new KeyBinding(
            "key.minimap.togglefullscreen", InputMappings.getInputByName("key.keyboard.x").getKeyCode(), "controls.minimap.title"
    );
    public KeyBinding keyBindMenu = new KeyBinding(
            "key.minimap.voxelmapmenu", InputMappings.getInputByName("key.keyboard.m").getKeyCode(), "controls.minimap.title"
    );
    ...
    public KeyBinding keyBindWaypoint = new KeyBinding(
            "key.minimap.waypointhotkey", InputMappings.getInputByName("key.keyboard.n").getKeyCode(), "controls.minimap.title"
    );
    ...
    private void bindKey(KeyBinding keyBinding, String id) {
        try {
            keyBinding.bind(InputMappings.getInputByName(id));
        } catch (Exception e) {
    ...
    public void saveAll() {
        ...
        try {
            ...
            out.println("Zoom Key:" + this.keyBindZoom.getTranslationKey());
            out.println("Fullscreen Key:" + this.keyBindFullscreen.getTranslationKey());
            out.println("Menu Key:" + this.keyBindMenu.getTranslationKey());
            out.println("Waypoint Menu Key:" + this.keyBindWaypointMenu.getTranslationKey());
            out.println("Waypoint Key:" + this.keyBindWaypoint.getTranslationKey());
            out.println("Mob Key:" + this.keyBindMobToggle.getTranslationKey());
            out.println("In-game Waypoint Key:" + this.keyBindWaypointToggle.getTranslationKey());
    ...
    public void setKeyBinding(KeyBinding keyBinding, Input input) {
