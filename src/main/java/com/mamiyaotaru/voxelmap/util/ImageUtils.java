...
public class ImageUtils {
    ...
    public static BufferedImage createBufferedImageFromResourceLocation(ResourceLocation resourceLocation) {
        try {
            InputStream is = Minecraft.getInstance().getResourceManager().getResource(resourceLocation).getInputStream();
    ...
    public static BufferedImage createBufferedImageFromCurrentGLImage() {
        ...
        if (size < 2147483647L) {
            ...
            GLShim.glPopMatrix();
            GLShim.glPopAttrib();
            GLShim.glViewport(0, 0, Minecraft.getInstance().mainWindow.getFramebufferWidth(), Minecraft.getInstance().mainWindow.getFramebufferHeight());
        }
    ...
    public static BufferedImage blankImage(String path, int w, int h, int imageWidth, int imageHeight, int r, int g, int b, int a) {
        try {
            InputStream is = Minecraft.getInstance().getResourceManager().getResource(new ResourceLocation(path)).getInputStream();
