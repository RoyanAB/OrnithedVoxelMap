...
import com.mojang.blaze3d.platform.GlStateManager.FaceSides;
...
public class GLShim {
    ...
    public static void glCullFace(int mode) {
        FaceSides cullFace = FaceSides.FRONT_AND_BACK;
        switch (mode) {
            case 1028:
                cullFace = FaceSides.FRONT;
                break;
            case 1029:
                cullFace = FaceSides.BACK;
            case 1030:
            case 1031:
            default:
                break;
            case 1032:
                cullFace = FaceSides.FRONT_AND_BACK;
        }
    ...
    public static void glGetFloat(int pname, FloatBuffer params) {
        GlStateManager.getMatrix(pname, params);
    }
    ...
    public static void glPixelStorei(int parameterName, int parameter) {
        GlStateManager.pixelStore(parameterName, parameter);
    }
