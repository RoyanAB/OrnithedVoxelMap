...
public class Contact {
    ...
    public void updateLocation() {
        this.x = this.entity.prevPosX + (this.entity.posX - this.entity.prevPosX) * Minecraft.getInstance().getRenderPartialTicks();
        this.y = (int) this.entity.posY + this.yFudge;
        this.z = this.entity.prevPosZ + (this.entity.posZ - this.entity.prevPosZ) * Minecraft.getInstance().getRenderPartialTicks();
    }
}
