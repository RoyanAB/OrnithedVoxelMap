...
public class GLUtils {
    private static final IntBuffer dataBuffer = GLAllocation.createDirectByteBuffer(16777216).asIntBuffer();
    public static TextureManager textureManager;
    public static int fboID = 0;
    public static boolean openGL14Enabled = GL.getCapabilities().OpenGL14;
    public static boolean fboEnabled = GL.getCapabilities().GL_EXT_framebuffer_object && openGL14Enabled;
    ...
    public static int tex(BufferedImage paramImg) {
        ...
        GlStateManager.pixelStorei(3316, 0);
        GlStateManager.pixelStorei(3315, 0);
