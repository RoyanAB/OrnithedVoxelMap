...
public class GuiSlotWaypoints extends GuiSlotMinimap {
	...
	protected void elementClicked(int slotIndex, boolean isSelected, int mouseX, int mouseY) {
		this.parentGui.setSelectedWaypoint(this.waypointsFiltered.get(slotIndex));
	...
	protected boolean isSelected(int slotIndex) {
		return this.waypointsFiltered.get(slotIndex).equals(this.parentGui.selectedWaypoint);
	}
