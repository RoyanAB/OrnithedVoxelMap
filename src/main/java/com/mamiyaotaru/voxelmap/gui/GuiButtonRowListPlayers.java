...
public class GuiButtonRowListPlayers extends GuiListExtended {
	...
	public class Row implements IGuiListEntry {
		...
		public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
			this.drawButton(this.button, slotIndex, x, y, listWidth, slotHeight, mouseX, mouseY, isSelected);
			this.drawButton(this.button1, slotIndex, x, y, listWidth, slotHeight, mouseX, mouseY, isSelected);
			this.drawButton(this.button2, slotIndex, x, y, listWidth, slotHeight, mouseX, mouseY, isSelected);
		}
